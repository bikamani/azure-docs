...
Enter your **IoT Hub Connection String** in the first field and click **Update**. This step configures the tool so that it can communicate with IoT Hub. **Connection String** can be found under IoT Hub service settings->Shared Access Policies->iothubowner.
